...
//                    assertEquals(infoExpected.gameState.playerStates.get(0). );
                }
                assertEquals(infoExpected.gameState.playerStates, info.gameState.playerStates);
    ...
    @Test void test_GameInfo(){
        List<GameInfo> gamesInfo = createGameInfo(2);
